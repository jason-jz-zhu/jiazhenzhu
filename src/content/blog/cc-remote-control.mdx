---
title: "Claude Code Remote Control: Code From Your Phone in 2 Minutes"
description: "How to set up Claude Code Remote Control to code from your phone — full setup guide in 2 minutes."
date: 2026-03-25
tags: ["ai", "claude-code", "developer-tools", "ai-productivity"]
---
...
*I spend $200/month on Claude and use it for everything from building tools to writing this article. If you want to see more of my AI workflow, [subscribe to my Substack](https://substack.com/@jiazhenzhu) for deeper dives.*
